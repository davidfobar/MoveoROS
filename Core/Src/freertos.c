...
/* Definitions for blinkyTest */
osThreadId_t blinkyTestHandle;
const osThreadAttr_t blinkyTest_attributes = {
  .name = "blinkyTest",
  .stack_size = 128 * 4,
...
void MX_FREERTOS_Init(void) {
  ...
  /* Create the thread(s) */
  /* creation of blinkyTest */
  blinkyTestHandle = osThreadNew(StartBlinkyTest, NULL, &blinkyTest_attributes);
...
/* USER CODE BEGIN Header_StartBlinkyTest */
/**
  * @brief  Function implementing the blinkyTest thread.
  * @param  argument: Not used
  * @retval None
  */
/* USER CODE END Header_StartBlinkyTest */
void StartBlinkyTest(void *argument)
{
  /* USER CODE BEGIN StartBlinkyTest */
  /* Infinite loop */
  for(;;)
  {
    osDelay(1);
  }
  /* USER CODE END StartBlinkyTest */
}
